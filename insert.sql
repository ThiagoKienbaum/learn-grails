...
set @idProduto =(select id from produto where tipo='BEBIDA' and id not in (select produto_id from estoque) order by rand() limit 1);
insert into estoque(version,produto_id,quantidade,quantidade_minima)
...
update produto p set estoque_id=(select id from estoque where produto_id=p.id);
...
insert into preferencias_clientes(cliente_id,produto_id) values ( (select id from cliente order by rand() limit 1), (select id from produto order by rand() limit 1));
insert into preferencias_clientes(cliente_id,produto_id) values ( (select id from cliente order by rand() limit 1), (select id from produto order by rand() limit 1));
insert into preferencias_clientes(cliente_id,produto_id) values ( (select id from cliente order by rand() limit 1), (select id from produto order by rand() limit 1));
insert into preferencias_clientes(cliente_id,produto_id) values ( (select id from cliente order by rand() limit 1), (select id from produto order by rand() limit 1));
insert into preferencias_clientes(cliente_id,produto_id) values ( (select id from cliente order by rand() limit 1), (select id from produto order by rand() limit 1));
...
#insere os pedidos
insert into pedido(version,cliente_id,data_hora,valor_total) values (0,(select id from cliente order by rand() limit 1),DATE_SUB(now(),INTERVAL round(rand()*30,0) DAY),0);
insert into pedido(version,cliente_id,data_hora,valor_total) values (0,(select id from cliente order by rand() limit 1),DATE_SUB(now(),INTERVAL round(rand()*30,0) DAY),0);
insert into pedido(version,cliente_id,data_hora,valor_total) values (0,(select id from cliente order by rand() limit 1),DATE_SUB(now(),INTERVAL round(rand()*30,0) DAY),0);
insert into pedido(version,cliente_id,data_hora,valor_total) values (0,(select id from cliente order by rand() limit 1),DATE_SUB(now(),INTERVAL round(rand()*30,0) DAY),0);
insert into pedido(version,cliente_id,data_hora,valor_total) values (0,(select id from cliente order by rand() limit 1),DATE_SUB(now(),INTERVAL round(rand()*30,0) DAY),0);
...
insert into item_pedido(version,observacao,pedido_id,produto_id,quantidade,valor_venda) values (0,null,@idPedido,@idProduto,round(rand()*2+1,0),@valorVenda);
...
update pedido p set valor_total=(select sum(valor_venda*quantidade) from item_pedido where pedido_id=p.id) where id in (select pedido_id from item_pedido);